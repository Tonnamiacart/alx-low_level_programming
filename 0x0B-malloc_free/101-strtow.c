...
/**
 * strncat_mod - this concatenates string with n bytes from another string
...
/**
 * word_count - this funtion counts words in input string
 * @str: input string
 * @str_len: string length
 * Return: 0;
 */
...
/**
 * strtow - this funtion splits a string into words
